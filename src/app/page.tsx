...
export default function HomePage() {
  return (
    <div className="min-h-screen">
      ...
      {/* 特徴セクション */}
      <section className="gradient-bg py-24 lg:py-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10">
            <div className="floating-card group scale-in glow-effect" style={{animationDelay: '0.1s'}}>
              <div className="bg-gradient-to-br from-blue-600 to-cyan-600 w-20 h-20 rounded-3xl flex items-center justify-center mb-8 group-hover:scale-110 transition-all duration-500 floating glow-effect">
            ...
            <div className="floating-card group scale-in glow-effect" style={{animationDelay: '0.2s'}}>
              <div className="bg-gradient-to-br from-purple-600 to-pink-600 w-20 h-20 rounded-3xl flex items-center justify-center mb-8 group-hover:scale-110 transition-all duration-500 floating glow-effect" style={{animationDelay: '1s'}}>
            ...
            <div className="floating-card group scale-in glow-effect" style={{animationDelay: '0.3s'}}>
              <div className="bg-gradient-to-br from-green-600 to-emerald-600 w-20 h-20 rounded-3xl flex items-center justify-center mb-8 group-hover:scale-110 transition-all duration-500 floating glow-effect" style={{animationDelay: '2s'}}>
            ...
            <div className="floating-card group scale-in glow-effect" style={{animationDelay: '0.4s'}}>
              <div className="bg-gradient-to-br from-orange-600 to-yellow-600 w-20 h-20 rounded-3xl flex items-center justify-center mb-8 group-hover:scale-110 transition-all duration-500 floating glow-effect" style={{animationDelay: '0.5s'}}>
            ...
            <div className="floating-card group scale-in glow-effect" style={{animationDelay: '0.5s'}}>
              <div className="bg-gradient-to-br from-indigo-600 to-blue-600 w-20 h-20 rounded-3xl flex items-center justify-center mb-8 group-hover:scale-110 transition-all duration-500 floating glow-effect" style={{animationDelay: '1.5s'}}>
            ...
            <div className="floating-card group scale-in glow-effect" style={{animationDelay: '0.6s'}}>
              <div className="bg-gradient-to-br from-teal-600 to-cyan-600 w-20 h-20 rounded-3xl flex items-center justify-center mb-8 group-hover:scale-110 transition-all duration-500 floating glow-effect" style={{animationDelay: '2.5s'}}>
